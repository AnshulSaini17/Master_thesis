...
class TensordyneLlamaDecoderLayer(nn.Module):
    ...
    def _repeat_kv(self, x):
        ...
        if self.num_kv_heads == self.num_heads:
            return x
        return nn.repeat_interleave(x, repeats=self.num_kv_groups, axis=1)
